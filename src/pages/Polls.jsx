...
const Polls = () => {
	...
	const add = () => {
		console.log(JSON.stringify(virtualOptions));
						...
						<div className='addPoll__wrapper'>
							<div className='addPoll__body'>
								...
								<TextField
									...
									variant='standard'
									onChange={(t) =>
										setQuestionText(t.target.value)
									}
								/>
								<br />
								<br />
								<Button
									variant={
										openChoices ? 'outlined' : 'contained'
									}
									onClick={() => {
										addQuestion();
