...
const Login = props => {
  ...
  return (
    <div className={c.loginBody}>
      <Box component="form" noValidate autoComplete="on" onSubmit={login}>
        <div className="login__control">
          <div className="login__label">
            <label id="username-lbl">Логин *</label>
            <TextField
              error={emailDirty}
              id="outlined"
        ...
        <div className="login__control">
          <div className="login__label">
            <label id="password-lbl">Пароль</label>
      ...
      <ul className="login__links">
        <li className="login__links_item">
          <Link to="/login/register">Ещё нет учётной записи?</Link>
        </li>
      </ul>
    </div>
  );
