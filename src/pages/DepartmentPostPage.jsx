...
const DepartmentPostPage = () => {
    ...
    const [postData, setPostData] = useState({
        nameOfDepartment: "Управление бюджетной политики",
        bossData: {
        ...
        innerDepartments: [
            {
                ...
                stuff: [
                    ...
                    ["https://picsum.photos/130/180", "Сарбанова Анжелика Николаевна", "Заведующий отделом", "1112", "62-53-13", "a.sarbanova@minfin.kg", "213"],
                    ["https://picsum.photos/130/180", "Шаршенова Токтобубу Джолдошовна", "Главный специалист", "1121", "62-53-13", "t.sharshenova@minfin.kg", "219"],
                ]
            },
            {
    ...
    return (
        <div className='page-body'>
            <h1 style={{color: "black"}}>{postData.nameOfDepartment}</h1>
            <p>Печать(пусто)</p>
            <h4 style={{color: "black"}}>{postData.nameOfDepartment}</h4>
            <TableContainer>
